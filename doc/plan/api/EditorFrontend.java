public interface EditorFrontend{
  ...
  /**
  * Creates a view with a parameter of javafx content that can 
  * be displayed
  ...
  **/
  ...
  /**
  * Gets the most =clicked/selected component the user interacted with, if last thing clicked wasn't a component, return null
