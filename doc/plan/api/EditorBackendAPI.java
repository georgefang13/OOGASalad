public interface EditorBackend {
    ...
    */
     ...
     * example:
     * GameObject board = (Ownable) querySelector(".board");
     * @return the first Ownable that matches the selector
     */
    public Ownable querySelector(String selector);

    /**
     * Query for all matching Ownables (GameObjects, Variables) based on ID (#) or class (.)
     * example:
    ...
    /**
     * Gets a list of all board templates, including name and description (contained in BoardTemplateSpecifier)
