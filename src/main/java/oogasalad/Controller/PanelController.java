...
/**
 * @author Han
 * This is a smaller controller that allows for the panel to direclty call on functions from the Window
 * Controller instead of having to call on Window. This is implements Chain of Responsibility design
 * pattern
 */
