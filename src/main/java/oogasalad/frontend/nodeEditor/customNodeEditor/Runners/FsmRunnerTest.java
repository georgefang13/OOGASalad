...
public class FsmRunnerTest extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    textButton.setOnAction(event -> gameColumn.setContent(new TextFieldNode(50, 50, DEFAULT_WIDTH, DEFAULT_HEIGHT, "white")));
  ...
  public String sendAllNodeContent() {
    ...
    for (Node node: pane2.getChildren()) {
      returnable += ((OogaNode) node).sendContent();
    }
    return returnable;
  }
}