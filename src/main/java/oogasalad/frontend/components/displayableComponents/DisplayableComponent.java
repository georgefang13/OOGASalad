...
/**
 * @author Han, Aryan This is the component for all View Elements that are visible inside the View
 * editor.
 */
public interface DisplayableComponent extends Component {
  ...
  /**
   * This is the method that allows for Components to be assigned a z value. The ZIndez dictates
   * which Components are visible above each other. For example, if a Board has a z value of 1, and
   * the GameObject Bishop has a z value of 2, the Bishop will be viewed on top
   */
