...
/**
 * @author Han, Aryan These are the components of the View that represent Rule and Goal creation
 */
public interface LogicComponent extends DisplayableComponent {

  /**
   * This is the method to get the LogicComponents contained within this LogicComponent. For
   * example, getChildren for an if block returns all the LogicComponents contained within the
   * ifBlock.
   *
  ...
  /**
   * This is the method to get the LogicComponent that is connected from the beginning of this
   * block. This is the LogicComponent that "flows" into the current Logic Component
   *
