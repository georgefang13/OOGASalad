...
public class SplashMainScene extends AbstractScene {
  ...
  public Scene makeScene() {
    ...
    playButton.setOnAction(e -> getWindow().windowController.registerAndShow(WindowTypeEnum.WindowType.GAME_WINDOW));
    Button editButton = new Button("Edit Game"); //TODO: Properties File
    editButton.setOnAction(e -> getWindow().windowController.registerAndShow(WindowTypeEnum.WindowType.EDIT_WINDOW));
