...
public class RandomRange extends OperatorToken {
    ...
    public ValueToken<Double> evaluate(Environment env){
        ...
        ValueToken<Double> min = checkArgumentWithSubtype(env, t1, ValueToken.class, Double.class.getName());
        ValueToken<Double> max = checkArgumentWithSubtype(env, t2, ValueToken.class, Double.class.getName());
