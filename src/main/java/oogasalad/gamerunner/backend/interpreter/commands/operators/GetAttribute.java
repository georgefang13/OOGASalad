...
public class GetAttribute extends OperatorToken {
    ...
    public Token evaluate(Environment env) {
        ...
        ValueToken<GameObject> x1 = checkArgumentWithSubtype(env, t1, ValueToken.class, GameObject.class.getName());
        ValueToken<String> x2 = checkArgumentWithSubtype(env, t2, ValueToken.class, String.class.getName());
