...
public class DropZone {
    ...
    public boolean addOutgoingConnection(DropZone toNode, String label) {
        if (toNode == null) throw new IllegalArgumentException("Cannot add null node to graph.");
        if (label == null || label.isEmpty()) throw new IllegalArgumentException("Edge name cannot be empty.");
